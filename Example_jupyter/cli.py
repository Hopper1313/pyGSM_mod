import argparse
import textwrap
from pyGSM.gsm_runner import gsm_api, gsm_config
...
def parse_arguments(verbose=True):
    ...
    parser.add_argument('-xyzfile', help='XYZ file containing reactant and, if DE-GSM, product.', required=False)
    ...
    parser.add_argument('-mode', default="DE_GSM", help='GSM Type (default: %(default)s)',
                        choices=["DE_GSM", "SE_GSM", "SE_Cross"], type=str, required=False)
